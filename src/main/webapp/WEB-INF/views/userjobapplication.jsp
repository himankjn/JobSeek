...
<%--				//company--%>
				<div>
					...
					<h3>Applicant Name: ${user.firstName} ${user.lastName}</h3>
					<h3>Accepted: ${jobapp.interviewAccepted}</h3>
					<h3>Interview Location: ${jobapp.interviewLocation}</h3>
					<h3>Interview Time: ${jobapp.interviewTime}</h3>
					<h3>Resume: ${jobapp.resume}</h3>
					<h3>State: ${jobapp.state}</h3>
				</div>
